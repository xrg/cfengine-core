...
void HandleFunctionExec ARGLIST((char* args,char *value,int useshell));
void HandleStatInfo ARGLIST((enum builtin fn,char* args,char *value));
void HandleCompareStat ARGLIST((enum builtin fn,char* args,char *value));
...
void GetExecOutput ARGLIST((char *command, char *buffer,int useshell));
...
int FuzzyHostMatch ARGLIST((char *arg0, char *arg1,char *basename));
int FuzzyHostParse ARGLIST((char *arg1,char *arg2));
